        ...
        <div className={o.content}>
            ...
            <ul className={o.overview}>
                <li className={o.profile}>
                    <header>
                        <Image src={user.data.body.data.avatar} width="72" height="72" alt="Avatar" />
                        <div className={o.data}>
                            <h1>{user?.data.body.data.username}</h1>
                            <p>{user.data.body.data.email}</p>
                        </div>
                    </header>
                    ...
                    <header>
                        <div className={o.name}>
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 24 24">
                                <path d="M 12 4 A 7.5 7.5 0 0 0 5.3515625 8.0429688 A 6 6 0 0 0 0 14 A 6 6 0 0 0 6 20 L 19 20 A 5 5 0 0 0 24 15 A 5 5 0 0 0 19.34375 10.017578 A 7.5 7.5 0 0 0 12 4 z"></path>
                            </svg>
                            <h1>Files</h1>
