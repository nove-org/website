...
export default function RootLayout({ children }: { children: React.ReactNode }) {
    ...
    const sidebar = [
        ...
        { label: 'Billing', path: '/account/billing', target: 'billing' },
    ];
                        ...
                        <li>
                            <a>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0,0,256,256">
                                    <g transform="translate(16,16) scale(0.875,0.875)">
                                        <g
                                            fill="currentColor"
                                            fillRule="nonzero"
                                            stroke="none"
