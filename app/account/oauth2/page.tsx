                    ...
                    <div key={connection.id} className={o.card}>
                        <div className={o.header}>
                            ...
                            <div className={o.info}>
                                ...
                                <p>
                                    {connection.app.description} &middot; {lang.getProp('by-who', { author: connection.app.owner })}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className={o.links}>
                            ...
                            <Link className="btn" href={connection.app.link_privacy_policy}>
                                ...
                                {lang.getCustomProp('modules.footer.ul-privacy')}
                            </Link>
                            <Link className="btn" href={connection.app.link_tos}>
                                ...
                                {lang.getCustomProp('modules.footer.ul-terms')}
                            </Link>
                        </div>
                        <h1 className={o.sectionTitle}>
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="16" height="16" viewBox="0 0 24 24">
                        ...
                        <div className={o.footer}>
                            {lang.getProp('first-access', {
                                date: new Date(connection.createdAt).toLocaleDateString(user.language, {
                                    year: 'numeric',
                                    month: 'short',
                                    day: 'numeric',
                                    hour: 'numeric',
                            ...
                            <br />
                            {lang.getProp('last-login', {
                                date: new Date(connection.updatedAt).toLocaleDateString(user.language, {
                                    year: 'numeric',
                                    month: 'short',
                                    day: 'numeric',
                                    hour: 'numeric',
