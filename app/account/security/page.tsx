        ...
        <div className={o.content}>
            ...
            <div className={o.securityLayers}>
                <Header
                    ...
                    Add or modify ways of signing in and confirming your identity.
                </Header>
            ...
            <div className={o.deleteAccount}>
                <Header
                    title="Delete your Nove account"
                    ...
                    account will be deleted from our servers instantly! You can delete your account anytime you want. Please, make sure that you have removed all third-party
                    accounts you registered using your Nove account. Otherwise - you won't be able to log in to them.
                </Header>
